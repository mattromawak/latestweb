...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) ||  empty($contact) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        if ($password !== $confirm_password) {
            ...
            if ($result_username->num_rows > 0) {
                ...
                $sql = "INSERT INTO users (username, contact, email, password) VALUES ('$username', '$contact', '$email', '$hashed_password')";
